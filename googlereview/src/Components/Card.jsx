...
const App = () => {
  return (
    <div>
        ...
        "><h3 className='text-2xl text-white my-3'>Charles Robie</h3>
        <h1 className='text-5xl text-white my-3'>Welcome Reviews Dashboard</h1></div>
      <div className="flex justify-center items-center">
        <div className="p-4 m-4 rounded-lg w-[295px] h-[97px] shadow-md bg-[#FFCF4E] flex">
          <img src={Group} alt="" />
          <div className="mx-4">
        ...
        <div className="p-4 m-4 w-[295px] h-[97px] rounded-lg shadow-md bg-[#FFCF4E] flex">
          <img src={Group} alt="" />
          <div className="mx-4">
        ...
        <div className="p-4 m-4 w-[295px] h-[97px] rounded-lg shadow-md bg-[#FFFFF] text-[#FFCF4E] flex">
          <div className="mx-4">
